                ...
                <div class="row mt-3 mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item">Department Heads</li>
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select class="form-control select2 select2-primary" id="rights" data-dropdown-css-class="select2-primary" style="width: 100%;">
                                <option selected="selected">{{ $user->rights ?? 'Select a Right' }}</option>
                ...
                <div class="row mt-5">
                    <div class="col-12">
                        ...
                        <input type="submit" value="Update Department Head" class="btn btn-success float-right">
                    </div>
                </div>
            </div>
        </div>
